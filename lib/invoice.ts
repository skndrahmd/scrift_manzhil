...
export async function generateMaintenanceInvoicePdf(
  ...
  doc.setFont("helvetica", "normal")
  doc.setFontSize(11)
  doc.text("Thank you for keeping your maintenance dues up to date with Greens Three.", 20, afterSummary + 21)
...
export async function generateBookingInvoicePdf(booking: any) {
  ...
  doc.text(
    [
      ...
      "For any changes, contact the Greens Three admin office at your earliest convenience.",
    ],
    14,
    137,
  )
